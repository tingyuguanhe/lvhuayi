  ...
  <div>
    ...
    <div>
      ...
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column fixed prop="date" label="公告id" width="150"></el-table-column>
        <el-table-column prop="name" label="创建时间" width="120"></el-table-column>
        <el-table-column prop="province" label="公告状态" width="120"></el-table-column>
        <el-table-column prop="city" label="权重" width="120"></el-table-column>
        <el-table-column prop="address" label="公告标题" width="300"></el-table-column>
