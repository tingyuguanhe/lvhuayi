<template>
  <div>
    <div class="filter_wrap">
      ...
      >
        ...
        <el-form-item label="活动状态">
          <el-select size="small" clearable v-model="ruleForm.status" placeholder="请选择活动状态">
            <el-option
              :label="item.label"
              :value="item.value"
    ...
    <div>
      <el-button size="small" type="primary" @click="addItem()">新建活动</el-button>

      <el-table :data="tableData" border v-loading="loading" style="width: 100%">
        <el-table-column fixed prop="id" label="活动id" width="70"></el-table-column>
    ...
    <!-- 查看组件 -->
    <pre-view :dialogShow.sync="dialogShow" :title="'活动'" :currentRow="currentRow"></pre-view>
  </div>
</template>    
...
export default {
  ...
  methods: {
    ...
    async getListData() {
      ...
      let res = await getActivityList(reqData);
      if (res.code == 200) {
    ...
    handleClickEdit(row) {
      this.$router.push({ name: "editActivity", params: { id: row.id } });
    },
