      ...
      <el-col :span="15">
        <div class="grid-content bg-purple">
          <el-tabs v-model="activeName" @tab-click="handleClick(activeName)">
            <el-tab-pane label="英文活动" name="en"></el-tab-pane>
            <el-tab-pane label="中文活动" name="zh-CN"></el-tab-pane>
          </el-tabs>
          <!-- 英文活动 -->
          <el-form
            key="en"
          ...
          >
            <div v-show="activeName == 'en'">
              ...
              <el-form-item label="活动头图" prop="imageEng">
                <el-upload
                  key="en"
            ...
            <div v-show="activeName == 'zh-CN'">
              ...
              <el-form-item label="活动头图" prop="image">
                <el-upload
                  key="zhcn"
                  class="avatar-uploader"
                  :action="domain"
...
export default {
  ...
  methods: {
    ...
    async getDetail() {
      let res = await ActivityApi.getItemDetail(this.id);
      if (res.code == 200) {
        console.log(res);
        let Data = res.data;
    ...
    submitForm(formName) {
      this.$refs[formName].validate(async valid => {
        if (valid) {
          ...
          if (this.id) {
            //修改
            let res = await ActivityApi.updateActivity(this.ruleForm);
            if (res.code == 200) {
            ...
            let res = await ActivityApi.createActivity(this.ruleForm);
            if (res.code == 200) {
