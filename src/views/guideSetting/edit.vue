        ...
        <div class="grid-content bg-purple">
          ...
          >
            <div v-show="activeName == 'en'">
              ...
              <el-form-item label="指引头图" prop="imageEng">
                <el-upload
                  key="en"
            ...
            <div v-show="activeName == 'zh-CN'">
              ...
              <el-form-item label="指引头图" prop="image">
                <el-upload
                  key="zhcn"
                  class="avatar-uploader"
                  :action="domain"
...
export default {
  ...
  methods: {
    ...
    async getDetail() {
      let res = await GuideApi.getItemDetail(this.id);
      if (res.code == 200) {
        console.log(res);
        let Data = res.data;
    ...
    submitForm(formName) {
      this.$refs[formName].validate(async valid => {
        if (valid) {
          ...
          if (this.id) {
            //修改
            let res = await GuideApi.updateGuide(this.ruleForm);
            if (res.code == 200) {
            ...
            let res = await GuideApi.createNotice(this.ruleForm);
            if (res.code == 200) {
